...
export function SessionRow({
  ...
  /* ── Бүдгэрэх нь ХААГДСАН гэсэн үг, БОЛОМЖГҮЙ гэсэн үг биш ──────────────
     Өмнө нь мөр `bookable` биш бол бүгд бүдгэрдэг байв. Гэвч `bookable`
     нь дөрвөн өөр шалтгаанаар худал болдог бөгөөд тэдгээрийн хоёр нь
     бүдгэрэх ёсгүй:

       · цуцлагдсан, өнгөрсөн → мөр ҮНЭХЭЭР үхсэн, бүдгэрэх нь зөв
       · дүүрсэн              → хүлээлгийн жагсаалтад орж БОЛНО, тэр
                                товч бүдгэрвэл олдохоо болино
       · аль хэдийн бүртгүүлсэн → энэ бол ЭЕРЭГ төлөв. Хэрэглэгчийн
                                өөрийнх нь хичээл цуцлагдсан хичээлтэй
                                ижил харагдах нь буруу мессеж, дээр нь
                                `text-muted` дээр 55% давхарлахад
                                ялгаралт WCAG-ийн босгоос доош унана.

     Тиймээс зөвхөн үнэхээр хаагдсан хоёр төлөв бүдгэрнэ. */
