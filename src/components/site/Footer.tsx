...
/**
 * Хуудасны хөл — суурийн дээр өргөгдсөн ГАДАРГА.
 *
 * ── Яагаад карт ───────────────────────────────────────────────────────────
 ...
 *
 * ── Яагаад гадарга ────────────────────────────────────────────────────────
 * Өмнө нь энэ нь ЦАГААН карт байв — харанхуй хуудсан дээрх хамгийн хүчтэй
 * зогсоох дохио. Гэвч сайт ганц горимтой болмогц тэр цагаан хавтан нь
 * системийн гадна үлдсэн ганц муж болж, «гэрэлтэй горим гоожиж байна» гэж
 * уншигдах болов.
 *
 * Одоо зогсоолтыг ӨНГӨ БИШ ХЭЛБЭР хийнэ: дөрвөн талаараа хаагдсан, доороо
 * зайтай, суурийн дээр нэг шат өргөгдсөн гадарга. Доторх гарын үсгийн мөр
 * дахин нэг шат дээш гарч, картын дотор өөрийн давхарга үүсгэнэ.
 *
 * Доторх бүрдлүүд дахин бичигдээгүй: бүгд токен уншдаг тул самбарын
 * гадаргатай хамт өөрсдөө тохирно (§ globals.css `.panel`).
 */
export async function Footer({ locale }: { locale: Locale }) {
  ...
  return (
    ...
    <footer className="mt-[var(--bay)] pb-28 lg:pb-10">
      <div className="shell">
        <div className="panel overflow-hidden rounded-[var(--r-xl)]" data-rv="scale">
