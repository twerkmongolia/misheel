...
/**
 * Google -ийн АЛБАН ЁСНЫ «G» — дөрвөн өнгөтэй.
 *
 * ── Яагаад энэ ганц зүйл өнгөтэй байхыг зөвшөөрч байна вэ ─────────────────
 * Сайт бүхэлдээ монохром. Гэвч энэ тэмдэг нь манай биш — БУСДЫН тэмдэг.
 * Google -ийн брэндийн журам нь логог дахин будахыг хориглодог ба хэрэглэгч
 * тэр дөрвөн өнгийг «Google» гэж УНШДАГ: монохром хувилбар нь «энэ товч
 * ажиллах болов уу» гэсэн эргэлзээ төрүүлнэ. Нэвтрэлт бол эргэлзэх газар
 * биш — итгэл нь зурлагаас илүү үнэ цэнэтэй.
 *
 * `viewBox` нь 48 — албан ёсны эх файлын хэмжээ. Зам бүрийг дахин зурахгүй
 * ЯГ хэвээр нь авсан: ойролцоо хуулбар нь танигдахаа больдог.
 */
export function GoogleMark({ className = '' }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" aria-hidden="true" className={`h-[18px] w-[18px] shrink-0 ${className}`}>
      <path
        fill="#4285F4"
