...
/**
 * Гүйлтийн хөдөлгөөнийг ЗЭВСЭГЛЭНЭ.
 *
 * Загварын хуудсанд элементүүд анхдагчаар ХАРАГДАНА — зөвхөн `rv-on` анги
 * байгаа үед нуугдана. Тиймээс JS унтарсан, унасан, эсвэл скрипт ачаалагдаагүй
 * бол агуулга бүтнээрээ үлдэнэ: хөдөлгөөн бол чимэглэл, агуулгын урьдчилсан
